...
class BooleanValidator extends Validator<dynamic> {
  ...
  BooleanValidator isTrue({String message = "Must be true"}) {
    return addRule((value) {
      final bool? parsedValue = parseValue(value?.toString());
      return parsedValue == true ? null : message;
    }) as BooleanValidator;
  }
  ...
  BooleanValidator isFalse({String message = "Must be false"}) {
    return addRule((value) {
      final bool? parsedValue = parseValue(value?.toString());
      return parsedValue == false ? null : message;
    }) as BooleanValidator;
  }
  ...
  BooleanValidator matches(bool expectedValue, {String? message}) {
    return addRule((value) {
      final bool? parsedValue = parseValue(value?.toString());
      return parsedValue == expectedValue ? null : (message ?? "Must be $expectedValue");
    }) as BooleanValidator;
  }
  ...
  BooleanValidator xor(bool otherValue, {String message = "Must be XOR true"}) {
    return addRule((value) {
      final bool? parsedValue = parseValue(value?.toString());
      return (parsedValue != null && (parsedValue ^ otherValue)) ? null : message;
    }) as BooleanValidator;
  }
  ...
  BooleanValidator equals(bool expected, {String message = "Must match expected value"}) {
    return addRule((value) {
      final bool? parsedValue = parseValue(value?.toString());
      return parsedValue == expected ? null : message;
    }) as BooleanValidator;
  }
